...
export const syncMedia: SyncMedia[] = [
  // ── Films ───────────────────────────────────────────────────────────────────
  {
    ...
    type: 'film',
    year: 2022,
    posterUrl: '/posters/black-panther-wakanda-forever.jpg',
    ...
    rating: 7.006,
    musicCredits: [
      { name: 'Ludwig Göransson', job: 'Original Music Composer', tmdbId: 928158 },
      { name: 'Dave Jordan', job: 'Music Supervisor', tmdbId: 24192 },
    ],
  },
  {
    id: 'queen-and-slim',
    ...
    type: 'film',
    year: 2019,
    posterUrl: '/posters/queen-slim.jpg',
    ...
    rating: 7.133,
    musicCredits: [
      { name: 'Kier Lehman', job: 'Music Supervisor', tmdbId: 1530088 },
      { name: 'Devonté Hynes', job: 'Original Music Composer', tmdbId: 1677382 },
      { name: 'Megan Thee Stallion', job: 'Songs', tmdbId: 2396830 },
      { name: 'VickeeLo', job: 'Songs', tmdbId: 6090022 },
    ],
  },
  {
    ...
    type: 'film',
    year: 2023,
    posterUrl: '/posters/spider-man-across-the-spider-verse.jpg',
    ...
    rating: 8.336,
    musicCredits: [
      { name: 'Daniel Pemberton', job: 'Original Music Composer', tmdbId: 582922 },
      { name: 'Kier Lehman', job: 'Music Supervisor', tmdbId: 1530088 },
    ],
  },
  {
    ...
    type: 'film',
    year: 2021,
    posterUrl: '/posters/coming-2-america.jpg',
    ...
    rating: 6.336,
    musicCredits: [
      { name: 'Jermaine Stegall', job: 'Original Music Composer', tmdbId: 1010915 },
      { name: 'Megan Thee Stallion', job: 'Songs', tmdbId: 2396830 },
      { name: 'Bobby Sessions', job: 'Songs', tmdbId: 6090012 },
      { name: 'YG', job: 'Songs', tmdbId: 1282495 },
      { name: 'Big Sean', job: 'Songs', tmdbId: 1338269 },
    ],
  },
  {
    id: 'the-woman-king',
    ...
    type: 'film',
    year: 2022,
    posterUrl: '/posters/the-woman-king.jpg',
    ...
    rating: 7.589,
    musicCredits: [
      { name: 'Terence Blanchard', job: 'Original Music Composer', tmdbId: 5287 },
    ],
  },
  {
    id: 'f1-2025',
    ...
    rating: 7.797,
    musicCredits: [
      { name: 'Hans Zimmer', job: 'Original Music Composer', tmdbId: 947 },
    ],
  },
  {
    ...
    type: 'film',
    year: 2015,
    posterUrl: '/posters/beasts-of-no-nation.jpg',
    ...
    rating: 7.586,
    musicCredits: [
      { name: 'Dan Romer', job: 'Original Music Composer', tmdbId: 1155140 },
      { name: 'Tracy McKnight', job: 'Music Supervisor', tmdbId: 1526823 },
    ],
  },
  {
    ...
    type: 'film',
    year: 2018,
    posterUrl: '/posters/pacific-rim-uprising.jpg',
    ...
    rating: 6.128,
    musicCredits: [
      { name: 'Lorne Balfe', job: 'Original Music Composer', tmdbId: 929145 },
    ],
  },
  ...
  // ── TV Shows ────────────────────────────────────────────────────────────────
  {
    ...
    rating: 7.141,
    musicCredits: [
      { name: 'Matthew Newman Dunne', job: 'Original Music Composer', tmdbId: 6247520 },
    ],
  },
  {
    id: 'queen-sono',
    ...
    type: 'tv',
    year: 2020,
    posterUrl: '/posters/queen-sono.jpg',
  ...
  },
  {
    ...
    type: 'tv',
    year: 2023,
    posterUrl: '/posters/everything-now.jpg',
  ...
  },
  {
    ...
    type: 'tv',
    year: 2019,
    posterUrl: '/posters/euphoria.jpg',
    ...
    musicCredits: [
      { name: 'Hans Zimmer', job: 'Original Music Composer', tmdbId: 947 },
      { name: 'Gabe Hilfer', job: 'Music Supervisor', tmdbId: 1529999 },
    ],
  },
  {
    id: 'blood-and-water',
    ...
    type: 'tv',
    year: 2020,
    posterUrl: '/posters/blood-water.jpg',
  ...
  // ── New Films ──────────────────────────────────────────────────────────────
  {
    ...
    rating: 7.364,
    musicCredits: [
      { name: 'Kendrick Lamar', job: 'Music', tmdbId: 1008292 },
      { name: 'Ludwig Göransson', job: 'Original Music Composer', tmdbId: 928158 },
    ],
  },
  {
    ...
    rating: 6.9,
    musicCredits: [
      { name: 'Mark Ronson', job: 'Songs', tmdbId: 77071 },
      { name: 'Andrew Wyatt', job: 'Songs', tmdbId: 1077876 },
      { name: 'Billie Eilish', job: 'Songs', tmdbId: 2413513 },
      { name: 'FINNEAS', job: 'Songs', tmdbId: 1396403 },
      { name: 'Andrew Wyatt', job: 'Original Music Composer', tmdbId: 1077876 },
    ],
  },
  {
    id: 'get-out-2017',
    ...
    rating: 7.624,
    musicCredits: [
      { name: 'Christopher T. Mollere', job: 'Music Supervisor', tmdbId: 1761131 },
    ],
  },
  {
    id: 'creed-iii-2023',
    ...
    type: 'film',
    year: 2023,
    posterUrl: '/posters/creed-iii.jpg',
  ...
  },
  {
    ...
    rating: 6.55,
    musicCredits: [
      { name: 'Steven Price', job: 'Original Music Composer', tmdbId: 16368 },
    ],
  },
  {
    ...
    type: 'film',
    year: 2024,
    posterUrl: '/posters/mufasa-the-lion-king.jpg',
    ...
    rating: 7.307,
    musicCredits: [
      { name: 'Lin-Manuel Miranda', job: 'Songs', tmdbId: 1179651 },
      { name: 'Dave Metzger', job: 'Original Music Composer', tmdbId: 61974 },
      { name: 'Elton John', job: 'Songs', tmdbId: 11370 },
    ],
  },
  ...
  // ── New TV Shows ───────────────────────────────────────────────────────────
  {
    ...
    rating: 8,
    musicCredits: [
      { name: 'Jen Malone', job: 'Music Supervisor', tmdbId: 2023802 },
      { name: 'Ludwig Göransson', job: 'Original Music Composer', tmdbId: 928158 },
    ],
  },
  {
    ...
    rating: 8,
    musicCredits: [
      { name: 'Brian Eno', job: 'Original Music Composer', tmdbId: 37317 },
      { name: 'Ed Bailie', job: 'Music Supervisor', tmdbId: 3982830 },
      { name: 'Abi Leland', job: 'Music Supervisor', tmdbId: 1631498 },
      { name: 'Toby Williams', job: 'Music Supervisor', tmdbId: 6215428 },
    ],
  },
  {
    ...
    rating: 8.563,
    musicCredits: [
      { name: 'Nora Felder', job: 'Music Supervisor', tmdbId: 1824567 },
      { name: 'Kyle Dixon', job: 'Original Music Composer', tmdbId: 1685626 },
      { name: 'Michael Stein', job: 'Original Music Composer', tmdbId: 2225636 },
    ],
  },
  {
    id: 'wednesday-tv',
    ...
    rating: 8.345,
    musicCredits: [
      { name: 'Chris Bacon', job: 'Original Music Composer', tmdbId: 71268 },
    ],
  },
  ...
  },
  {
    ...
    rating: 6.907,
    musicCredits: [
      { name: 'Stephen Schwartz', job: 'Original Music Composer', tmdbId: 42910 },
      { name: 'Maggie Rodford', job: 'Music Supervisor', tmdbId: 1540471 },
      { name: 'John Powell', job: 'Original Music Composer', tmdbId: 11098 },
    ],
  },
  {
    id: 'moana-2-2024',
    ...
    rating: 7.007,
    musicCredits: [
      { name: 'Abigail Barlow', job: 'Songs', tmdbId: 3889426 },
      { name: 'Emily Bear', job: 'Songs', tmdbId: 3877305 },
      { name: 'Mark Mancina', job: 'Songs', tmdbId: 9989 },
      { name: 'Opetaia Foa\'i', job: 'Songs', tmdbId: 1716551 },
    ],
  },
  {
    ...
    type: 'film',
    year: 2024,
    posterUrl: '/posters/gladiator-ii.jpg',
    ...
    rating: 6.609,
    musicCredits: [
      { name: 'Harry Gregson-Williams', job: 'Original Music Composer', tmdbId: 5553 },
    ],
  },
  {
    ...
    type: 'film',
    year: 2025,
    posterUrl: '/posters/one-of-them-days.jpg',
    ...
    rating: 6.7,
    musicCredits: [
      { name: 'Sarah Bromberg', job: 'Music Supervisor', tmdbId: 1606938 },
      { name: 'Stephanie Diaz-Matos', job: 'Music Supervisor', tmdbId: 1473576 },
      { name: 'Chanda Dancy', job: 'Original Music Composer', tmdbId: 1381723 },
    ],
  },
  {
    ...
    type: 'film',
    year: 2023,
    posterUrl: '/posters/the-color-purple.jpg',
    ...
    rating: 6.982,
    musicCredits: [
      { name: 'Allee Willis', job: 'Songs', tmdbId: 2167926 },
      { name: 'Stephen Bray', job: 'Songs', tmdbId: 73350 },
      { name: 'Brenda Russell', job: 'Songs', tmdbId: 2167925 },
      { name: 'Quincy Jones', job: 'Songs', tmdbId: 13301 },
      { name: 'Kris Bowers', job: 'Original Music Composer', tmdbId: 1802871 },
    ],
  },
  {
    ...
    type: 'film',
    year: 2024,
    posterUrl: '/posters/bob-marley-one-love.jpg',
    ...
    musicCredits: [
      { name: 'Kris Bowers', job: 'Original Music Composer', tmdbId: 1802871 },
      { name: 'Bob Marley', job: 'Songs', tmdbId: 123073 },
    ],
  },
  ...
  // ── 2024–2026 TV Shows ─────────────────────────────────────────────────────
  {
    ...
    rating: 7.9,
    musicCredits: [
      { name: 'Jung Jae-il', job: 'Original Music Composer', tmdbId: 2127965 },
      { name: 'Park Min-joo', job: 'Original Music Composer', tmdbId: 5536332 },
      { name: 'Kim Sungsoo', job: 'Original Music Composer', tmdbId: 3595492 },
    ],
  },
  {
    id: 'the-bear-tv',
  ...
  },
  {
    ...
    rating: 8.413,
    musicCredits: [
      { name: 'Leopold Ross', job: 'Original Music Composer', tmdbId: 968471 },
      { name: 'Nick Chuba', job: 'Original Music Composer', tmdbId: 1676921 },
      { name: 'Atticus Ross', job: 'Original Music Composer', tmdbId: 142391 },
    ],
  },
  {
    id: 'griselda-tv',
    ...
    type: 'tv',
    year: 2024,
    posterUrl: '/posters/griselda.jpg',
    ...
    rating: 7.244,
    musicCredits: [
      { name: 'Carlos Rafael Rivera', job: 'Original Music Composer', tmdbId: 1392836 },
    ],
  },
  {
    id: 'the-gentlemen-tv',
    ...
    type: 'tv',
    year: 2024,
    posterUrl: '/posters/the-gentlemen.jpg',
    ...
    rating: 7.823,
    musicCredits: [
      { name: 'Chris Benstead', job: 'Original Music Composer', tmdbId: 1335568 },
      { name: 'Ian Neil', job: 'Music Supervisor', tmdbId: 45056 },
      { name: 'Iain Cooke', job: 'Music Supervisor', tmdbId: 1606169 },
    ],
  },
  ...
  // ── 2025–2026 Films ────────────────────────────────────────────────────────
  {
    ...
    rating: 7.3,
    musicCredits: [
      { name: 'Ryan Lott', job: 'Original Music Composer', tmdbId: 3469777 },
      { name: 'Rafiq Bhatia', job: 'Original Music Composer', tmdbId: 3555893 },
      { name: 'Ian Chang', job: 'Original Music Composer', tmdbId: 3555894 },
    ],
  },
  {
    ...
    type: 'film',
    year: 2025,
    posterUrl: '/posters/captain-america-brave-new-world.jpg',
    ...
    musicCredits: [
      { name: 'Dave Jordan', job: 'Music Supervisor', tmdbId: 24192 },
      { name: 'Laura Karpman', job: 'Original Music Composer', tmdbId: 52515 },
    ],
  },
  {
    ...
    musicCredits: [
      { name: 'Dave Jordan', job: 'Music Supervisor', tmdbId: 24192 },
      { name: 'Rob Simonsen', job: 'Original Music Composer', tmdbId: 1042699 },
    ],
  },
  {
    id: 'dune-2-2024',
  ...
  },
  {
    ...
    rating: 7.545,
    musicCredits: [
      { name: 'Andrea Datzman', job: 'Original Music Composer', tmdbId: 1565455 },
      { name: 'Michael Giacchino', job: 'Music', tmdbId: 15347 },
    ],
  },
  ...
  // ── 2025–2026 TV Shows ─────────────────────────────────────────────────────
  {
    ...
    type: 'tv',
    year: 2025,
    posterUrl: '/posters/severance.jpg',
    ...
    rating: 8.4,
    musicCredits: [
      { name: 'Theodore Shapiro', job: 'Original Music Composer', tmdbId: 10572 },
    ],
  },
  {
    id: 'white-lotus-tv',
    ...
    type: 'tv',
    year: 2025,
    posterUrl: '/posters/the-white-lotus.jpg',
    ...
    musicCredits: [
      { name: 'Gabe Hilfer', job: 'Music Supervisor', tmdbId: 1529999 },
      { name: 'Cristóbal Tapia de Veer', job: 'Original Music Composer', tmdbId: 1554206 },
    ],
  },
  {
    id: 'adolescence-tv',
    ...
    type: 'tv',
    year: 2025,
    posterUrl: '/posters/adolescence.jpg',
    ...
    rating: 7.84,
    musicCredits: [
      { name: 'Aaron May', job: 'Original Music Composer', tmdbId: 2498626 },
      { name: 'David Ridley', job: 'Original Music Composer', tmdbId: 2498627 },
    ],
  },
  {
    id: 'black-mirror-tv',
    ...
    type: 'tv',
    year: 2025,
    posterUrl: '/posters/black-mirror.jpg',
  ...
  },
  {
    ...
    rating: 8.427,
    musicCredits: [
      { name: 'Scott Hanau', job: 'Music Supervisor', tmdbId: 6215343 },
      { name: 'Gustavo Santaolalla', job: 'Original Music Composer', tmdbId: 278 },
      { name: 'Ian Broucek', job: 'Music Supervisor', tmdbId: 1901938 },
      { name: 'Evyen Klean', job: 'Music Supervisor', tmdbId: 1541694 },
      { name: 'David Fleming', job: 'Original Music Composer', tmdbId: 1639821 },
    ],
  },
