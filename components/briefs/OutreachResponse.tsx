...
export function OutreachResponse({ outreachId, status, briefId, submissions }: Props) {
  ...
  return (
    <div className="rounded-[0.375rem] border bg-surface-secondary/50 backdrop-blur-md p-8 shadow-elevation-low transition-all flex flex-col gap-6">
      <div className="flex flex-col gap-3">
        <p className="label">Invitation</p>
        <h2 className="text-2xl display text-foreground">You've been invited to submit</h2>
